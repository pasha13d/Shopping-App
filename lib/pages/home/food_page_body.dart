...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        /// SLIDER, scrolling card with bottom card using Stack
        Container(
            ...
            return Container(
              ...
              child: Row(
                children: [
                  ...
                  /// Text section
                  /// Expanded will force the widget to get all the available space
                  Expanded(
                    child: Container(
      ...
      child: Stack(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadiusDirectional.circular(Dimensions.radius30),
